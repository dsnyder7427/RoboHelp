...
`wd_List_Rename_Flags`
    ...
    What kind of rename? (Similar to `WDAPI_RF_FLAG_*`). For a list of total available flags, see [Available Flags for wd_List_Rename_Flags](/docs/## Available Flags for wd_List_Rename_Flags).
