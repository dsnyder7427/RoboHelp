...
What kind of rename? (Similar to `WDAPI_RF_FLAG_*`). For a list of total available flags, see [Available Flags for wd_List RENAME Flags](#available-flags-for-wd-list-rename-flags).
